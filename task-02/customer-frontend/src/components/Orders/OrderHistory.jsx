...
export default function OrderHistory() {
  const { customerId, triggerRefresh } = useCart();
  const { orders, loading, error, refetch, getOrder, cancelOrder, refundOrder } = useOrders(customerId);
          ...
          <table className={styles.table}>
            ...
            <tbody>
              {orderList.map((order) => {
                ...
                const formattedDate = (order.created_at || order.createdAt)
